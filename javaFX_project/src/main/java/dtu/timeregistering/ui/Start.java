        ...
        do {
            ...
            if (nr == 2) {
                ...
                //Select a number
                    ...
                    // 2.
                do {
                    System.out.println("0. To go back to main page");
                    ...
                    nr2 = timeapp.getInt(console,"Enter a number from the list above: ", 0, 10);
                    console.nextLine(); // (Skal være her for at det virker, men gør i princippet ingenting)
                    //2.1
                    if (nr2 == 1) {
                    ...
                    if (nr2 == 2){
                        ...
                        do{
                            ...
                            nr3 = timeapp.getInt(console,"Enter a number from the list above: ", 0, 10);
                    ...
                    if (nr2 == 3){
                        //select projectmamanger(skal omrkives)
